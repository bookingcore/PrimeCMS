...
use Modules\Core\Admin\Core\Globals\AdvancedFilter;
use Modules\Core\Admin\Core\RootAdmin;
...
class ModuleProvider extends BaseModuleProvider
{
    ...
    public function register()
    {
        ...
        Livewire::component('root-admin', RootAdmin::class);
        Livewire::component('Core::admin.globals.advanced-filter', AdvancedFilter::class);
